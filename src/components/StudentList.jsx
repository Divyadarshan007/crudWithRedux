    ...
    return (
        <div>
            ...
            <div className="flex justify-end container mx-auto">
                <button onClick={()=> navigate('/add-student')} className="border rounded p-3 px-5 bg-blue-600 text-white font-medium">Add Student</button>
            </div>
                            ...
                            students.map((std) => {
                                return <tr key={std.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                    ...
                                    <td className="px-6 py-4 flex gap-5">
                                        <button className="text-blue-700 font-semibold text-md">Edit</button>
